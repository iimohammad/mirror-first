...
> **میرور از قبل بالاست و فقط می‌خواهی یک سرور ایران را وصل کنی؟**
> برو سراغ [`QUICKSTART.md`](QUICKSTART.md) — همان چند دستور، بدون توضیح اضافه.
>
> **چیزی می‌خواهی که پکیج نیست؟** `git clone`، دانلود از گیت‌هاب، APIهای
> مدل‌های زبانی — [`SNI.md`](SNI.md).
